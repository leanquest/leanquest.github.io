...
export const metadata: Metadata = {
  ...
  title: "LeanQuest — The Proof Tower",
  description:
  ...
  openGraph: {
    title: "LeanQuest",
    description: "Choose your proof path and defeat 55 tower guardians with Lean.",
    images: [{ url: "/assets/cc0_images/og-v0.1.2.png", width: 1536, height: 1024 }],
  },
  twitter: {
    card: "summary_large_image",
    title: "LeanQuest — The Proof Tower",
    description: "Master term or tactic proofs across two complete tower ascents.",
